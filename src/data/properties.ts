...
export const properties: Property[] = [
  ...
  },
  {
    ...
    price: 260000,
    pricePerAcre: 66411,
    propertyType: "Land - Single Lot",
    status: "For Sale",
    highlights: [
      "3.92 Acres",
      "40x60 Metal Structure Included",
      "15 min from Bastrop",
      "Panoramic Views",
      "$66,411 / Acre",
      "No Mobile Homes",
    ...
    exterior: {
      "Lot Description": "Agricultural, Level, Open Lot, Trees-Moderate",
      "Utility": "Electricity Available, Sewer Not Available",
      "Road Surface": "Dirt, Gravel",
      "Views": "Panoramic, Pasture, Trees/Woods",
    },
  },
  // === FOR RENT ===
  {
