  ...
  const steps = [
    {
      ...
      description: "Choose the time that works best for you. It's free, no obligation, and takes approximately 30 minutes.",
    },
    {
      number: "02",
      icon: MessageSquare,
      title: "Understand your entire process",
      description: "In our call, we analyze your current situation and I explain step by step what you need to know to buy smart.",
    },
    {
      number: "03",
      icon: CheckCircle2,
      title: "Move forward with clarity",
      description: "With a clear plan in mind, you'll be able to make informed decisions and move forward with complete confidence toward your new home.",
    },
  ];
      ...
      <div ref={ref} className={`container scroll-reveal ${isVisible ? "visible" : ""}`}>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {steps.map((step, index) => (
            <div
              key={index}
              className="relative text-center group scroll-reveal-child"
